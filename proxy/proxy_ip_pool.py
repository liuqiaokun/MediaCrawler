...
class ProxyIpPool:
    ...
    def __init__(
        ...
        Args:
            ...
            ip_provider:
        """
        self.valid_ip_url = validate_url or "https://echo.apifox.cn/"  # URL to validate if IP is valid
    ...
    def is_current_proxy_expired(self, buffer_seconds: int = 10) -> bool:
        """
    ...
    async def get_or_refresh_proxy(self, buffer_seconds: int = 10) -> IpInfoModel:
        """
